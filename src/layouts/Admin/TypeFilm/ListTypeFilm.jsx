...
import TypeFilmTable from './Components/TypeFilmTable';
import { actFetchsTypeRequest } from '../../../Redux/Actions/Admin/filmAction';
import { apiAdminTypeFilm } from '../../../services/adminApi';


function ListTypeFilm(props) {
    const dispatch = useDispatch();
    const history = useHistory();
    const typefilms = useSelector(state => state.TypeFilmReducer);
    
    console.log(typefilms);
    const onClickUpdate = (typefilm) => {
        const editFilmUrl = `/admin/typefilm/edit/${typefilm.id}`;
        ...
        (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    apiAdminTypeFilm.fetchApiDeleteTypeFilm(id).then(res => {
                        Swal.fire(
                            'Deleted!',
                            ...
                            <div className="tab-pane fade show active" id="Departments-list" role="tabpanel">
                                <div className="card">
                                    <div className="card-header">
                                        <h3 className="card-title">List Type List</h3>
                                                ...
                                                <tbody>
                                                    {
                                                        ...
                                                        typefilms.map((item,index) =>(
                                                            <TypeFilmTable key={index} data={item}
                                                            index={index}
